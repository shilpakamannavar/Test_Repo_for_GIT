...
/**
 * Class ImportHex Command
 */
class ImportHex extends Command
{
    ...
    {
        $this->setName('auraine:import:hex')
            ...
            if ($optionId) {
                ...
                if ($swatchOptions) {
                    ...
                    $connection->query(
                            ...
                            SET value= '{$hexCodeValue}' WHERE option_id = '{$optionId}'"
                        );
                    }
                } else {
                    $connection->query(
                    "INSERT INTO `eav_attribute_option_swatch` (`option_id`, `store_id`, `type`, `value`)
                            VALUES ({$optionId},0,'1','{$hexCodeValue}')"
                );
                    }
