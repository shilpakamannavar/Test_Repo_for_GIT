<?php
namespace Auraine\BannerSlider\Test\Unit\Model\Slider;
...
/**
 * @covers \Auraine\BannerSlider\Model\Slider\DataProvider
 */
class DataProviderTest extends TestCase
{
     ...
     * Object to test
     *
     * @var \Auraine\BannerSlider\Model\Slider\DataProvider
     */
    private $testObject;
    ...
    public function setUp() : void
    {
        ...
        $this->testObject = $this->objectManager->getObject(
            \Auraine\BannerSlider\Model\Slider\DataProvider::class,
            [
                'name' => $this->name,
