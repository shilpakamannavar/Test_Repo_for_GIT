...
class Save extends \Magento\Backend\App\Action
{
  ...
  /**
   * @var \Auraine\ImageUploader\Model\ImageFactory
   */
   ...
   */
     ...
     * @param \Auraine\ImageUploader\Model\ImageFactory $imageFactory
     */
    public function __construct(
        Context $context,
        UploaderFactory $uploaderFactory,
        Filesystem $filesystem,
        \Auraine\ImageUploader\Model\ImageFactory $imageFactory
    ) {
