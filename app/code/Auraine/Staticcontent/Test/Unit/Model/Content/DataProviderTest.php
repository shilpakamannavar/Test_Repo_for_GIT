...
/**
 * @covers \Auraine\Staticcontent\Model\Content\DataProvider
 */
class DataProviderTest extends TestCase
{
     ...
     * Object to test
     *
     * @var \Auraine\Staticcontent\Model\Content\DataProvider
     */
    private $testObject;
    ...
    public function setUp() : void
    {
        ...
        $this->collectionFactoryInstance = $this->createMock(
            \Auraine\Staticcontent\Model\ResourceModel\Content\Collection::class
        );
        $this->collectionFactory = $this->createMock(
            \Auraine\Staticcontent\Model\ResourceModel\Content\CollectionFactory::class
        );
        ...
        $this->testObject = $this->objectManager->getObject(
            \Auraine\Staticcontent\Model\Content\DataProvider::class,
            [
