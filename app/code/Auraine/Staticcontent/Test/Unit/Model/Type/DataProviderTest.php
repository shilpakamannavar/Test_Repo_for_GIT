...
namespace Auraine\Staticcontent\Test\Unit\Model\Type;
...
/**
 * @covers \Auraine\Staticcontent\Model\Type\DataProvider
 */
class DataProviderTest extends TestCase
{
     ...
     * Object to test
     *
     * @var \Auraine\Staticcontent\Model\Type\DataProvider
     */
    private $testObject;
    ...
    public function setUp() : void
    {
        ...
        $this->collectionFactoryInstance = $this->createMock(
            \Auraine\Staticcontent\Model\ResourceModel\Type\Collection::class
        );
        $this->collectionFactory = $this->createMock(
            \Auraine\Staticcontent\Model\ResourceModel\Type\CollectionFactory::class
        );
        ...
        $this->testObject = $this->objectManager->getObject(
            \Auraine\Staticcontent\Model\Type\DataProvider::class,
            [
