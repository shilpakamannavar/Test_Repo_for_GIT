...
namespace Auraine\Category\Test\Unit\Setup\Patch\Data;
...
use Auraine\Category\Setup\Patch\Data\AddBannerSliderAttribute;

class AddBannerSliderAttributeTest extends TestCase
{
    /**
     * @var AddBannerSliderAttribute
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new AddBannerSliderAttribute($this->moduleDataSetupMock, $this->eavSetupFactoryMock);
    }
    ...
    public function testRevertRemovesAttribute()
    {
        ...
        $eavSetupMock->expects($this->once())
            ...
            ->with(Category::ENTITY, AddBannerSliderAttribute::BANNER_SLIDER)
    ...
    public function testApplyAddsAddBannerSliderAttributeToCategoryEntity()
    {
        ...
        $eavSetup->expects($this->once())
            ...
            ->with(
                Category::ENTITY,
                AddBannerSliderAttribute::BANNER_SLIDER,
                [
        ...
        $object = new AddBannerSliderAttribute($moduleDataSetup, $eavSetupFactory);
        $object->apply();
    }
    ...
    public function testApply()
    {
        ...
        $patch = new AddBannerSliderAttribute($moduleDataSetup, $eavSetupFactory);
