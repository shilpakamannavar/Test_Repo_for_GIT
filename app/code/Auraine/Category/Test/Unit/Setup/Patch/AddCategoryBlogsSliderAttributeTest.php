...
use Auraine\Category\Setup\Patch\Data\AddCategoryBlogsSliderAttribute;

class AddCategoryBlogsSliderAttributeTest extends TestCase
{
    /**
     * @var AddCategoryBlogsSliderAttribute
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new AddCategoryBlogsSliderAttribute($this->moduleDataSetupMock, $this->eavSetupFactoryMock);
    }
    ...
    public function testRevertRemovesAttribute()
    {
        ...
        $eavSetupMock->expects($this->once())
            ...
            ->with(Category::ENTITY, AddCategoryBlogsSliderAttribute::CATEGORY_BLOGS_SLIDER)
    ...
    /**
     * testApplyAddsAddBlogsSliderAttributeToCategoryEntity
     *
     * @return void
     */
    public function testApplyAddsAddBlogsSliderAttributeToCategoryEntity()
    {
        ...
        $eavSetup->expects($this->once())
            ...
            ->with(
                Category::ENTITY,
                AddCategoryBlogsSliderAttribute::CATEGORY_BLOGS_SLIDER,
                [
        ...
        $object = new AddCategoryBlogsSliderAttribute($moduleDataSetup, $eavSetupFactory);
        $object->apply();
    }
    ...
    public function testApply()
    {
        ...
        $patch = new AddCategoryBlogsSliderAttribute($moduleDataSetup, $eavSetupFactory);
