...
use Auraine\Category\Setup\Patch\Data\AddCategoryBannerSliderAttribute;

class AddCategoryBannerSliderAttributeTest extends TestCase
{
    /**
     * @var AddCategoryBannerSliderAttribute
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new AddCategoryBannerSliderAttribute($this->moduleDataSetupMock, $this->eavSetupFactoryMock);
    }
    ...
    public function testRevertRemovesAttribute()
    {
        ...
        $eavSetupMock->expects($this->once())
            ...
            ->with(Category::ENTITY, AddCategoryBannerSliderAttribute::CATEGORY_BANNER_SLIDER)
    ...
    /**
     * testApplyAddsAddCategoryBannerAttributeToCategoryEntity
     *
     * @return void
     */
    public function testApplyAddsAddCategoryBannerAttributeToCategoryEntity()
    {
        ...
        $eavSetup->expects($this->once())
            ...
            ->with(
                Category::ENTITY,
                AddCategoryBannerSliderAttribute::CATEGORY_BANNER_SLIDER,
                [
                'group' => 'General Information',
                'type' => 'int',
                'backend' => '',
                'frontend' => '',
                'label' => 'Category Banner Slider',
                'input' => 'select',
                'class' => '',
                'source' => '',
                'visible' => true,
        ...
        $object = new AddCategoryBannerSliderAttribute($moduleDataSetup, $eavSetupFactory);
        $object->apply();
    }
    ...
    public function testApply()
    {
        ...
        $patch = new AddCategoryBannerSliderAttribute($moduleDataSetup, $eavSetupFactory);
