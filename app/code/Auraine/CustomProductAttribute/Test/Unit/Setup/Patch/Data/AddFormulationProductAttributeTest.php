...
use Auraine\CustomProductAttribute\Setup\Patch\Data\AddFormulationProductAttribute;
...
/**
 * Summary of AddFormulationProductAttributeTest
 */
class AddFormulationProductAttributeTest extends TestCase
{
    /**
     * @var AddFormulationProductAttribute
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new AddFormulationProductAttribute(
    ...
    public function testRevertRemovesAttribute()
    {
        ...
        $eavSetupMock->expects($this->once())
            ...
            ->with(Product::ENTITY, 'formulation')
