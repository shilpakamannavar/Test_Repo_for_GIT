...
use Auraine\CustomProductAttribute\Setup\Patch\Data\AddFreeProductAvailableProductAttribute;
...
/**
 * Summary of AddFreeProductAvailableProductAttributeTest
 */
class AddFreeProductAvailableProductAttributeTest extends TestCase
{
    /**
     * @var AddFreeProductAvailableProductAttribute
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new AddFreeProductAvailableProductAttribute(
    ...
    public function testRevertRemovesAttribute()
    {
        ...
        $eavSetupMock->expects($this->once())
            ...
            ->with(Product::ENTITY, 'free_product_available')
        ...
        $eavSetup->expects($this->once())
            ...
            ->with(
                ...
                [
                    ...
                    'option' => array('values' => array("Buy 2 Get 1 Free"))
                ]
            );
