...
use Auraine\CustomProductAttribute\Setup\Patch\Data\AddIsItHeatSensitiveProductAttribute;
...
/**
 * Summary of AddIsItHeatSensitiveProductAttributeTest
 */
class AddIsItHeatSensitiveProductAttributeTest extends TestCase
{
    /**
     * @var AddIsItHeatSensitiveProductAttribute
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new AddIsItHeatSensitiveProductAttribute(
    ...
    public function testRevertRemovesAttribute()
    {
        ...
        $eavSetupMock->expects($this->once())
            ...
            ->with(Product::ENTITY, 'is_it_heat_sensitive')
