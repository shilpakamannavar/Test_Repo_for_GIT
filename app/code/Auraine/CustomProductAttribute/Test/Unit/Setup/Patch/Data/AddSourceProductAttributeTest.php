...
use Auraine\CustomProductAttribute\Setup\Patch\Data\AddSourceProductAttribute;
...
/**
 * Summary of AddSourceProductAttributeTest
 */
class AddSourceProductAttributeTest extends TestCase
{
    /**
     * @var AddSourceProductAttribute
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new AddSourceProductAttribute(
        ...
        $eavSetup->expects($this->once())
            ...
            ->with(
                ...
                [
                    ...
                    'option' => array('values' => array("Internal","Seller"))
                ]
            );
