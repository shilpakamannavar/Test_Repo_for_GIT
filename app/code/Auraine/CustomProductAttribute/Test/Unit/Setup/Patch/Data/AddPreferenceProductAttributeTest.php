...
use Auraine\CustomProductAttribute\Setup\Patch\Data\AddPreferenceProductAttribute;
...
/**
 * Summary of AddPreferenceProductAttributeTest
 */
class AddPreferenceProductAttributeTest extends TestCase
{
    /**
     * @var AddPreferenceProductAttribute
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new AddPreferenceProductAttribute(
    ...
    public function testRevertRemovesAttribute()
    {
        ...
        $eavSetupMock->expects($this->once())
            ...
            ->with(Product::ENTITY, 'preference')
