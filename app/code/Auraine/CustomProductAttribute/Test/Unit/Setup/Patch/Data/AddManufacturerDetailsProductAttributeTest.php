...
use Auraine\CustomProductAttribute\Setup\Patch\Data\AddManufacturerDetailsProductAttribute;
...
/**
 * Summary of AddManufacturerDetailsProductAttributeTest
 */
class AddManufacturerDetailsProductAttributeTest extends TestCase
{
    /**
     * @var AddManufacturerDetailsProductAttribute
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new AddManufacturerDetailsProductAttribute(
    ...
    public function testRevertRemovesAttribute()
    {
        ...
        $eavSetupMock->expects($this->once())
            ...
            ->with(Product::ENTITY, 'manufacturer_details')
