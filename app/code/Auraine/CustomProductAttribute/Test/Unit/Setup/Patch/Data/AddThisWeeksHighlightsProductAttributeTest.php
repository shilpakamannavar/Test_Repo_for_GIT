...
use Auraine\CustomProductAttribute\Setup\Patch\Data\AddThisWeeksHighlightsProductAttribute;
...
/**
 * Summary of AddThisWeeksHighlightsProductAttributeTest
 */
class AddThisWeeksHighlightsProductAttributeTest extends TestCase
{
    /**
     * @var AddThisWeeksHighlightsProductAttribute
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new AddThisWeeksHighlightsProductAttribute(
    ...
    public function testRevertRemovesAttribute()
    {
        ...
        $eavSetupMock->expects($this->once())
            ...
            ->with(Product::ENTITY, 'this_weeks_highlights')
