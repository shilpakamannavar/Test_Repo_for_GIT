...
use Auraine\CustomProductAttribute\Setup\Patch\Data\AddSideEffectsSafetyWarningCaProductAttribute;
...
/**
 * Summary of AddSideEffectsSafetyWarningCaProductAttributeTest
 */
class AddSideEffectsSafetyWarningCaProductAttributeTest extends TestCase
{
    /**
     * @var AddSideEffectsSafetyWarningCaProductAttribute
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new AddSideEffectsSafetyWarningCaProductAttribute(
    ...
    public function testRevertRemovesAttribute()
    {
        ...
        $eavSetupMock->expects($this->once())
            ...
            ->with(Product::ENTITY, 'side_effects_safety_warning_ca')
    ...
    public function testApply()
    {
        ...
        $eavSetup->expects($this->once())
            ...
            ->with(
                ...
                [
                    'type' => 'text',
                    'label' => 'Side Effects/Safety/Warning/Caution',
                    'input' => 'textarea',
                    'source' => '',
                    'frontend' => '',
                    'required' => false,
