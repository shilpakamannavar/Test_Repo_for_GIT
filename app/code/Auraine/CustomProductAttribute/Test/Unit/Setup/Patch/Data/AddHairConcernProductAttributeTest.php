...
use Auraine\CustomProductAttribute\Setup\Patch\Data\AddHairConcernProductAttribute;
...
/**
 * Summary of AddHairConcernProductAttributeTest
 */
class AddHairConcernProductAttributeTest extends TestCase
{
    /**
     * @var AddHairConcernProductAttribute
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new AddHairConcernProductAttribute(
    ...
    public function testRevertRemovesAttribute()
    {
        ...
        $eavSetupMock->expects($this->once())
            ...
            ->with(Product::ENTITY, 'hair_concern')
