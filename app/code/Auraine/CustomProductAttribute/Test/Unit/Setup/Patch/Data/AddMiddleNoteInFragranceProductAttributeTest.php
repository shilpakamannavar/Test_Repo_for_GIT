...
use Auraine\CustomProductAttribute\Setup\Patch\Data\AddMiddleNoteInFragranceProductAttribute;
...
/**
 * Summary of AddMiddleNoteInFragranceProductAttributeTest
 */
class AddMiddleNoteInFragranceProductAttributeTest extends TestCase
{
    /**
     * @var AddMiddleNoteInFragranceProductAttribute
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new AddMiddleNoteInFragranceProductAttribute(
    ...
    public function testRevertRemovesAttribute()
    {
        ...
        $eavSetupMock->expects($this->once())
            ...
            ->with(Product::ENTITY, 'middle_note_in_fragrance')
    ...
    public function testApply()
    {
        ...
        $eavSetup->expects($this->once())
            ...
            ->with(
                ...
                [
                    'type' => 'varchar',
                'label' => 'Middle Note (in fragrance)',
                'input' => 'text',
                'source' => '',
                'frontend' => '',
                'required' => false,
