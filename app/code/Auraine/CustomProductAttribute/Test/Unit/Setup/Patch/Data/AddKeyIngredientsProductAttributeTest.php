...
use Auraine\CustomProductAttribute\Setup\Patch\Data\AddKeyIngredientsProductAttribute;
...
/**
 * Summary of AddKeyIngredientsProductAttributeTest
 */
class AddKeyIngredientsProductAttributeTest extends TestCase
{
    /**
     * @var AddKeyIngredientsProductAttribute
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new AddKeyIngredientsProductAttribute(
    ...
    public function testRevertRemovesAttribute()
    {
        ...
        $eavSetupMock->expects($this->once())
            ...
            ->with(Product::ENTITY, 'key_ingredients')
