...
use Auraine\CustomProductAttribute\Setup\Patch\Data\AddMdaSkuIdProductAttribute;
...
/**
 * Summary of AddMdaSkuIdProductAttributeTest
 */
class AddMdaSkuIdProductAttributeTest extends TestCase
{
    /**
     * @var AddMdaSkuIdProductAttribute
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new AddMdaSkuIdProductAttribute(
    ...
    public function testRevertRemovesAttribute()
    {
        ...
        $eavSetupMock->expects($this->once())
            ...
            ->with(Product::ENTITY, 'mda_sku_id')
