...
use Auraine\CustomProductAttribute\Setup\Patch\Data\AddShelfLifeInMonthsProductAttribute;
...
/**
 * Summary of AddShelfLifeInMonthsProductAttributeTest
 */
class AddShelfLifeInMonthsProductAttributeTest extends TestCase
{
    /**
     * @var AddShelfLifeInMonthsProductAttribute
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new AddShelfLifeInMonthsProductAttribute(
    ...
    public function testRevertRemovesAttribute()
    {
        ...
        $eavSetupMock->expects($this->once())
            ...
            ->with(Product::ENTITY, 'shelf_life_in_months')
