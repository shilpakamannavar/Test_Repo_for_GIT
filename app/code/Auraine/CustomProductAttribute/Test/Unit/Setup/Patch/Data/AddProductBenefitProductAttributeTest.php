...
use Auraine\CustomProductAttribute\Setup\Patch\Data\AddProductBenefitProductAttribute;
...
/**
 * Summary of AddProductBenefitProductAttributeTest
 */
class AddProductBenefitProductAttributeTest extends TestCase
{
    /**
     * @var AddProductBenefitProductAttribute
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new AddProductBenefitProductAttribute(
    ...
    public function testRevertRemovesAttribute()
    {
        ...
        $eavSetupMock->expects($this->once())
            ...
            ->with(Product::ENTITY, 'product_benefit')
