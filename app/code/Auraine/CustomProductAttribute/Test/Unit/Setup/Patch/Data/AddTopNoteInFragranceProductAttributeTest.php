...
use Auraine\CustomProductAttribute\Setup\Patch\Data\AddTopNoteInFragranceProductAttribute;
...
/**
 * Summary of AddTopNoteInFragranceProductAttributeTest
 */
class AddTopNoteInFragranceProductAttributeTest extends TestCase
{
    /**
     * @var AddTopNoteInFragranceProductAttribute
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new AddTopNoteInFragranceProductAttribute(
    ...
    public function testRevertRemovesAttribute()
    {
        ...
        $eavSetupMock->expects($this->once())
            ...
            ->with(Product::ENTITY, 'top_note_in_fragrance')
