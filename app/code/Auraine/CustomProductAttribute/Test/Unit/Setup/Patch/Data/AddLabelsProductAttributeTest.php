...
use Auraine\CustomProductAttribute\Setup\Patch\Data\AddLabelsProductAttribute;
...
/**
 * Summary of AddLabelsProductAttributeTest
 */
class AddLabelsProductAttributeTest extends TestCase
{
    /**
     * @var AddLabelsProductAttribute
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new AddLabelsProductAttribute(
        ...
        $eavSetup->expects($this->once())
            ...
            ->with(
                ...
                [
                    ...
                    'option' => array('values' => array("Best Seller","Featured","Exclusive","Just in"))
                ]
            );
