...
use Auraine\CustomProductAttribute\Setup\Patch\Data\AddDirectionForUseProductAttribute;
...
/**
 * Summary of AddDirectionForUseProductAttributeTest
 */
class AddDirectionForUseProductAttributeTest extends TestCase
{
    /**
     * @var AddDirectionForUseProductAttribute
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new AddDirectionForUseProductAttribute(
    ...
    public function testRevertRemovesAttribute()
    {
        ...
        $eavSetupMock->expects($this->once())
            ...
            ->with(Product::ENTITY, 'direction_for_use')
