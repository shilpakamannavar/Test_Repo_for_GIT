...
use Auraine\CustomProductAttribute\Setup\Patch\Data\AddLimitedPeriodOffersProductAttribute;
...
/**
 * Summary of AddLimitedPeriodOffersProductAttributeTest
 */
class AddLimitedPeriodOffersProductAttributeTest extends TestCase
{
    /**
     * @var AddLimitedPeriodOffersProductAttribute
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new AddLimitedPeriodOffersProductAttribute(
    ...
    public function testRevertRemovesAttribute()
    {
        ...
        $eavSetupMock->expects($this->once())
            ...
            ->with(Product::ENTITY, 'limited_period_offers')
