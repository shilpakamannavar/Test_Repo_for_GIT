...
use Auraine\CustomProductAttribute\Setup\Patch\Data\AddExchangeableProductAttribute;
...
/**
 * Summary of AddExchangeableProductAttributeTest
 */
class AddExchangeableProductAttributeTest extends TestCase
{
    /**
     * @var AddExchangeableProductAttribute
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new AddExchangeableProductAttribute(
    ...
    public function testRevertRemovesAttribute()
    {
        ...
        $eavSetupMock->expects($this->once())
            ...
            ->with(Product::ENTITY, 'exchangeable')
