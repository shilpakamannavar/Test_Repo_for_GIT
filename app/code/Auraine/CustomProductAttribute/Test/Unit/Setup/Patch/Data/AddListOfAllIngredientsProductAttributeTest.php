...
use Auraine\CustomProductAttribute\Setup\Patch\Data\AddListOfAllIngredientsProductAttribute;
...
/**
 * Summary of AddListOfAllIngredientsProductAttributeTest
 */
class AddListOfAllIngredientsProductAttributeTest extends TestCase
{
    /**
     * @var AddListOfAllIngredientsProductAttribute
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new AddListOfAllIngredientsProductAttribute(
    ...
    public function testRevertRemovesAttribute()
    {
        ...
        $eavSetupMock->expects($this->once())
            ...
            ->with(Product::ENTITY, 'list_of_all_ingredients')
