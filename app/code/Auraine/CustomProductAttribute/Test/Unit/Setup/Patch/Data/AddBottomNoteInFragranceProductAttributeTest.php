...
use Auraine\CustomProductAttribute\Setup\Patch\Data\AddBottomNoteInFragranceProductAttribute;
...
/**
 * Summary of AddBottomNoteInFragranceProductAttributeTest
 */
class AddBottomNoteInFragranceProductAttributeTest extends TestCase
{
    /**
     * @var AddBottomNoteInFragranceProductAttribute
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new AddBottomNoteInFragranceProductAttribute(
    ...
    public function testRevertRemovesAttribute()
    {
        ...
        $eavSetupMock->expects($this->once())
            ...
            ->with(Product::ENTITY, 'bottom_note_in_fragrance')
    ...
    public function testApply()
    {
        ...
        $eavSetup->expects($this->once())
            ...
            ->with(
                ...
                [
                    'type' => 'varchar',
                    'label' => 'Bottom Note in fragrance',
                    'input' => 'text',
                    'source' => '',
                    'frontend' => '',
                    'required' => false,
