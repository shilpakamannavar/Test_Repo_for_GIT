...
use Auraine\CustomProductAttribute\Setup\Patch\Data\AddReturnableProductAttribute;
...
/**
 * Summary of AddReturnableProductAttributeTest
 */
class AddReturnableProductAttributeTest extends TestCase
{
    /**
     * @var AddReturnableProductAttribute
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new AddReturnableProductAttribute(
    ...
    public function testRevertRemovesAttribute()
    {
        ...
        $eavSetupMock->expects($this->once())
            ...
            ->with(Product::ENTITY, 'returnable')
