...
use Auraine\CustomProductAttribute\Setup\Patch\Data\AddIsProductExpirableProductAttribute;
...
/**
 * Summary of AddIsProductExpirableProductAttributeTest
 */
class AddIsProductExpirableProductAttributeTest extends TestCase
{
    /**
     * @var AddIsProductExpirableProductAttribute
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new AddIsProductExpirableProductAttribute(
    ...
    public function testRevertRemovesAttribute()
    {
        ...
        $eavSetupMock->expects($this->once())
            ...
            ->with(Product::ENTITY, 'is_product_expirable')
