...
use Auraine\CustomProductAttribute\Setup\Patch\Data\AddBestSellerProductAttribute;
...
/**
 * Summary of AddBestSellerProductAttributeTest
 */
class AddBestSellerProductAttributeTest extends TestCase
{
    /**
     * @var AddBestSellerProductAttribute
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new AddBestSellerProductAttribute(
    ...
    public function testRevertRemovesAttribute()
    {
        ...
        $eavSetupMock->expects($this->once())
            ...
            ->with(Product::ENTITY, 'best_seller')
