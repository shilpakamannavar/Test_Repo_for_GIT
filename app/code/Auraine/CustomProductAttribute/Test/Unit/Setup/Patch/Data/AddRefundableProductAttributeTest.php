...
use Auraine\CustomProductAttribute\Setup\Patch\Data\AddRefundableProductAttribute;
...
/**
 * Summary of AddRefundableProductAttributeTest
 */
class AddRefundableProductAttributeTest extends TestCase
{
    /**
     * @var AddRefundableProductAttribute
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new AddRefundableProductAttribute(
    ...
    public function testRevertRemovesAttribute()
    {
        ...
        $eavSetupMock->expects($this->once())
            ...
            ->with(Product::ENTITY, 'refundable')
