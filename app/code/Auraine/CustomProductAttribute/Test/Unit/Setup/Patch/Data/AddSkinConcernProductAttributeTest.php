...
use Auraine\CustomProductAttribute\Setup\Patch\Data\AddSkinConcernProductAttribute;
...
/**
 * Summary of AddSkinConcernProductAttributeTest
 */
class AddSkinConcernProductAttributeTest extends TestCase
{
    /**
     * @var AddSkinConcernProductAttribute
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new AddSkinConcernProductAttribute(
    ...
    public function testRevertRemovesAttribute()
    {
        ...
        $eavSetupMock->expects($this->once())
            ...
            ->with(Product::ENTITY, 'skin_concern')
