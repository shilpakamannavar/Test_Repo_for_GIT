...
use Auraine\CustomProductAttribute\Setup\Patch\Data\AddFragranceFamilyProductAttribute;
...
/**
 * Summary of AddFragranceFamilyProductAttributeTest
 */
class AddFragranceFamilyProductAttributeTest extends TestCase
{
    /**
     * @var AddFragranceFamilyProductAttribute
     */
    private $patch;
    ...
    protected function setUp(): void
    {
        ...
        $this->patch = new AddFragranceFamilyProductAttribute(
    ...
    public function testRevertRemovesAttribute()
    {
        ...
        $eavSetupMock->expects($this->once())
            ...
            ->with(Product::ENTITY, 'fragrance_family')
