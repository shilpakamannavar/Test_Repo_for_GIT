...
class Edit extends \Auraine\PushNotification\Controller\Adminhtml\Template
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('auraine_pushnotification_template', $model);
        ...
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ? __('Edit Template %1', $model->getId()) : __('New Template'));
        return $resultPage;
    }
}
