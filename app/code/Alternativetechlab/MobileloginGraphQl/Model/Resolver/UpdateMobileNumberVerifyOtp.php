...
class UpdateMobileNumberVerifyOtp implements ResolverInterface
{
    ...
    public function resolve(
        ...
        if (!isset($args['newmobileNumber']) || !isset($args['otp']) || !isset($args['oldmobileNumber']) ||
            !isset($args['websiteId']) || empty($args['newmobileNumber']) || empty($args['otp']) ||
            empty($args['oldmobileNumber']) || empty($args['websiteId'])
        ) {
        ...
        try {
            ...
            if (count($collection) > 0) {
                $output = $this->helperData->verifyUpdateMobilenumberOTP(
                ...
                if ($output['status'] == 1) {
                    ...
                    return ["status" => true, "message" => __("Mobile number updated successfully.")];
                }
            } else {
