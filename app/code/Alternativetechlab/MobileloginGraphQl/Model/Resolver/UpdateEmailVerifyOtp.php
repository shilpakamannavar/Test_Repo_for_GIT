...
class UpdateEmailVerifyOtp implements ResolverInterface
{
    ...
    public function resolve(
        ...
        if (!isset($args['new_email']) || !isset($args['otp']) || !isset($args['old_email']) ||
            !isset($args['websiteId']) || empty($args['new_email']) || empty($args['otp']) ||
            empty($args['old_email']) || empty($args['websiteId'])
        ) {
        ...
        try {
            ...
            if (count($collection) > 0) {
                $output = $this->helperData->verifyUpdateEmailOTP(
