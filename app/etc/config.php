...
return [
    ...
    'modules' => [
        ...
        'Alternativetechlab_Mobilelogin' => 1,
        'Alternativetechlab_MobileloginGraphQl' => 1,
        'Alternativetechlab_Textlocal' => 1,
        ...
        'Magecomp_Mobilelogin' => 0,
        'Auraine_LoyaltyPoint' => 1,
        'Auraine_FreeShipping' => 1,
        'Auraine_FrequentlyBoughtTogether' => 1,
        ...
        'Auraine_ZipCode' => 1,
        'Fastly_Cdn' => 1,
        'Magecomp_MobileloginGraphQl' => 0,
        'Auraine_ExtendedPlaceOrderMutation' => 1,
        'Magecomp_Mobileloginmsg91' => 0,
        'Magecomp_Mobilelogintwilio' => 0,
        'Magecomp_Textlocal' => 0,
        'PayPal_Braintree' => 1,
